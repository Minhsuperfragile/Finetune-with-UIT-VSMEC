...
# python main.py --model gteSimFT --task evsim --config ./config/gte-multilingual-mlm-base.json --save-folder gteSimFT
# python main.py --model vietnamese-bi-encoder-ftstd-273339 --task evstd --config ./config/vietnamese-bi-encoder.json --save-folder vietnamese-bi-encoder-ftstd-273339
python main.py --