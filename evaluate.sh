...
python main.py --model gte-multilingual-mlm-base-26-3-6-7 --task evsim --config ./config/gte-multilingual-mlm-base.json --save-folder gte-multilingual-mlm-base-26-3-6-7